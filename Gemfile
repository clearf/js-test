...
group :development, :test do
  ...
  gem 'pry-byebug'          # Overcomes some issues w/ruby 2.0
  ...
  gem 'better_errors'       # Replaces the standard Rails error page with a much 
                            # better and more useful error page
                            # https://github.com/charliesome/better_errors
  gem 'binding_of_caller'   # Advanced features for better_errors advanced features 
                            # (REPL, local/instance variable inspection, pretty stack frame names)
                            # https://github.com/banister/binding_of_caller
  gem 'meta_request'        # Supporting gem for Rails Panel 
                            # (Google Chrome extension for Rails development).
